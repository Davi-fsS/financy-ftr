        ...
        <DialogContent className="border-2 border-solid p-6 border-gray-200 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <Input id="description" className="border-b-gray-300 py-6" placeholder="Ex. Almoço no restaurante"/>
                </div>
                
                <div className="flex gap-4">
                    <div className="flex-1">
                        <Label htmlFor="date" className="text-gray-700 font-medium text-sm">Data</Label>
                        <Input id="date" type="date" className="border-b-gray-300 py-6" placeholder="Selecione"/>                        
                    </div>

                    <div className="flex-1">
                        <Label htmlFor="value" className="text-gray-700 font-medium text-sm">Valor</Label>
                        <Input id="value" type="number" className="border-b-gray-300 py-6"/>                        
                    </div>
                </div>
